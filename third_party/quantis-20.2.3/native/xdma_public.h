 ...
 *
 * {E9A6DEC2-C135-4028-81E0-5CD341A7BA70}
 */
DEFINE_GUID(GUID_DEVINTERFACE_QUANTIS_PCIE,
	0xE9A6DEC2, 0xC135, 0x4028, 0x81, 0xE0, 0x5C, 0xD3, 0x41, 0xA7, 0xBA, 0x70);
